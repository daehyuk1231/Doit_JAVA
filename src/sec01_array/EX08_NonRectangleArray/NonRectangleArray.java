...
public class NonRectangleArray {
	public static void main(String[] args) {
		...
		System.out.println(array2[0][0] + " " + array2[1][1] + " " + array2[1][2]);
		System.out.println();

		int[][] array3 = new int[][] { { 1, 2 }, { 3, 4, 5 } };
		System.out.println(array3[0][0] + " " + array3[0][1]);
		System.out.println(array3[0][0] + " " + array3[1][1] + " " + array3[1][2]);
		System.out.println();

		int[][] array4;
		array4 = new int[][] { { 1, 2 }, { 3, 4, 5 } };
		System.out.println(array4[0][0] + " " + array4[0][1]);
		System.out.println(array4[0][0] + " " + array4[1][1] + " " + array4[1][2]);

		int[][] array5 = { { 1, 2 }, { 3, 4, 5 } };
		System.out.println(array5[0][0] + " " + array5[0][1]);
		System.out.println(array5[0][0] + " " + array5[1][1] + " " + array5[1][2]);
		System.out.println();
	}
}
